    ...
    <main className='p-3 max-w-4xl mx-auto'>
      ...
      <form className='flex flex-col sm:flex-row gap-6'>
        <div className='flex flex-col flex-1 gap-4'>
          ...
          id='name' maxLength='64' minLength='10' required/>
          ...
          <div className='flex flex-wrap gap-6'>
            <div className='flex items-center gap-2'>
              ...
              className='p-3 border-green-700 rounded-lg'/>
              <p>Bedrooms</p>
            </div>
            <div className='flex items-center gap-2'>
            ...
            <div className='flex items-center gap-2'>
              <input type="number" name="regularPrice" id="regularPrice" min='1' max='10' required
              className='p-3 border-green-700 rounded-lg'/>
            ...
            <div className='flex items-center gap-2'>
              <input type="number" name="discount" id="discount" min='1' max='10' required
              className='p-3 border-green-700 rounded-lg'/>
              <div className='flex flex-col items-center'>
                <p>Discount</p>
                <span className='text-xs'>($ / months)</span>
